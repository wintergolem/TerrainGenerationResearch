...
public class DiamondSquareTest : MonoBehaviour {
	...
	void Start () 
	{
		...
		fWidth = td.heightmapWidth;
		fHeight = td.heightmapHeight;

		fWidthfHeight= (float)fWidth+fHeight;
		
		//texture = new Texture2D(fWidth, fHeight);
		//renderer.material.mainTexture = texture;
		
		cols = new float[fWidth,fHeight];

		//drawPlasma(fWidth, fHeight);
	...
	{
		float max = num / fWidthfHeight * GRAIN;
